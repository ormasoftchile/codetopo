...
inline int run_mcp(const std::string& db_path, const std::string& root_hint,
    ...
    server.register_tool("symbol_list", tools::symbol_list,
        ...
        R"J({"type":"object","properties":{"kind":{"type":"string","description":"Filter by symbol kind: function, class, struct, variable, field, macro, etc."},"file_path":{"type":"string","description":"Filter to symbols in this file (relative path)"},"name_glob":{"type":"string","description":"SQLite GLOB pattern for symbol name (e.g. 'Get*', '*Handler')"},"compact":{"type":"boolean","description":"Compact output: omit qualname=name, collapse span to array, ~55% fewer tokens"},"fields":{"type":"array","items":{"type":"string"},"description":"Fields to include: node_id, name, qualname, kind, span, file_path. Overrides compact."},"min_span_lines":{"type":"integer","description":"Optional minimum symbol span in lines (inclusive)"},"limit":{"type":"integer","description":"Max results (default 200, max 2000)"},"offset":{"type":"integer","description":"Pagination offset (default 0)"}},"required":[]})J");
    ...
    server.register_tool("symbols_in_path", tools::symbols_in_path,
        ...
        R"J({"type":"object","properties":{"path":{"type":"string","description":"Directory path to search under"},"kind":{"type":"array","items":{"type":"string"},"description":"Symbol kinds to include (empty = all)"},"recursive":{"type":"boolean","default":true},"compact":{"type":"boolean","description":"Compact output: omit qualname=name, collapse span to array, ~55% fewer tokens"},"fields":{"type":"array","items":{"type":"string"},"description":"Fields to include: node_id, name, qualname, kind, span, file_path. Overrides compact."},"min_span_lines":{"type":"integer","default":0},"limit":{"type":"integer","default":200},"offset":{"type":"integer","default":0}}})J");

...
\begin{description}
  ...
  \item[Polyglot.] Thirteen languages are supported out of the box when
        experimental grammars are included: C, C++, C\#, TypeScript,
        JavaScript, Python, Rust, Java, Go, Bash, SQL, YAML, and Lua.\footnote{Lua
        is tracked as experimental; Simon's architecture notes enumerate the
        twelve production-ready languages without Lua.} Any language with a

...
CTE\footnote{SQLite has supported recursive CTEs since version 3.8.3
(released January 2014). The \texttt{UNION ALL} variant used here permits
revisiting nodes at greater depths; a set-based \texttt{UNION} would
deduplicate nodes but incur higher memory cost on large graphs.} expresses
this efficiently in SQLite:

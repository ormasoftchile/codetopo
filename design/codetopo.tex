...
\usepackage{graphicx}
\usepackage{triton}
\tritoncli{node /Users/cristianormazabal/Projects/triton/latex/dist/cli.cjs}
\usepackage{booktabs}
\usepackage{tabularx}
...
\input{sections/03-indexing-pipeline}
\input{sections/04-data-model}
\input{sections/05-mcp-protocol}
\input{sections/06-workspace}
\input{sections/07-query-engine}
\input{sections/08-related-work}
\input{sections/09-status}

...
|-----------|----------|----------|
| Architecture, system design | Simon 🏗️ | Module boundaries, data flow, API design |
| Code review | Simon 🏗️ | Review PRs, check quality, approve/reject |
| C++ core, threading, concurrency | Grag 🔧 | Indexer pipeline, thread pool, file I/O, data structures |
| Memory, arenas, performance | Otho ⚡ | Arena allocator, benchmarks, optimization |
| Tests, crash repro, scenarios | Joan 🧪 | Unit tests, integration tests, edge cases, regression |
| Scope & priorities | Simon 🏗️ | What to build next, trade-offs, decisions |
